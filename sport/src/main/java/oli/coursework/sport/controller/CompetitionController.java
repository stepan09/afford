...
public class CompetitionController {
    ...
    public List<Competition> getCompetitionsBySportKindIdAndCourtId(@PathVariable(value = "sportKindId") Long sportKindId, @PathVariable(value = "courtId") Long courtId){
